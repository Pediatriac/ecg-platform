          ...
          <div className="space-y-4">
            ...
            >
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: "#161616", color: roleColor }}
                >
            ...
            >
              ...
              <button
                ...
                className="w-full mt-4 py-2 rounded-lg text-sm font-bold text-white"
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            >
              <h2 className="text-white font-bold text-lg mb-5 flex items-center gap-2">
                <span style={{ color: "#9C27B0" }}>✏️</span> Edit Profile
              </h2>
            ...
            <div
              className="rounded-xl p-5"
              style={{ backgroundColor: "#161616", border: "1px solid #E91E8C22" }}
            >
              <p
                className="text-xs font-bold uppercase tracking-widest mb-3"
                style={{ color: "#E91E8C" }}
