    ...
    <div className="min-h-screen flex" style={{ backgroundColor: "#0a0a0a" }}>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center mb-8">
          <div
            className="p-1 rounded-full mb-6"
            style={{
              background:
                "linear-gradient(135deg, #FFEB3B 0%, #E91E8C 25%, #9C27B0 50%, #00BCD4 75%, #4CAF50 100%)",
            }}
          >
          ...
          <p className="text-gray-400 text-xs text-center mt-2 max-w-xs">
            ...
            <span style={{ color: "#00BCD4" }}>
              Doctors contact admin for access.
            </span>
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <p className="text-gray-400 text-sm mb-1">
            Join My ECGPediatric Portal today
          </p>
          <p className="text-xs mb-6" style={{ color: "#00BCD4" }}>
            👤 Patients register here — Doctors contact admin for access
          </p>
